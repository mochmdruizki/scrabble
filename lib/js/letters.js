...
function randomize() {
  ...
  randomConsonant = pickRandom(consonant, 6);
  randomVocal = pickRandom(vocal, 2);
  randomLetter = randomConsonant.concat(randomVocal);

  randomLetters = pickRandom(randomLetter, 8);
